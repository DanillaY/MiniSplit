...
auto read_proc_memory_string(int pid, uintptr_t base_module , uintptr_t offsets[], unsigned int offsets_len,unsigned int buffer_len, char buffer[], size_t buffer_size) {
