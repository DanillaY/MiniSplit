...
int main(int argc, char* argv[])
{
	...
	std::unordered_set<std::string> curr_values_split = {"CAKC","CASA", "CABH", "CASA", "CABH_NIGHT"};
	std::unordered_set<std::string> prev_values_split = {"BBLT","SACU", "MILL", "NIBA", "CAGP_NIGHT"};
	...
	Basic_Pointer_Info<std::string> bpoi_split_lev = Basic_Pointer_Info<std::string>(offsets4.size(), offsets4, new char[4],curr_values_split,prev_values_split,false,true,Signal_split::SPLIT);
    ...
    std::vector<std::function<void()>> all_functions = { start_memory_reader}; //put every reader function here
