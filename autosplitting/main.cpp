...
int main(int argc, char* argv[])
{
    ...
    std::vector<std::function<void()>> all_functions = { start_memory_reader_start,start_memory_reader,start_memory_reader_split_lev,start_memory_reader_split_cuts,}; //put every reader function here
