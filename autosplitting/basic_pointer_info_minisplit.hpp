...
class Basic_Pointer_Info {
	...
	public:
		...
		//use T compared_to or std::vector<T> compared_to_vec, compared_to_vec is used for comparing multiple current and previous values so that you wont have to initialize a new pointer class for each value but if you need to compare only 1 value then use T type 
